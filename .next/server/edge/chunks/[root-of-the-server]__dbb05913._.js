(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root-of-the-server]__dbb05913._.js", {
...
"[project]/lib/jwtToken.ts [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function signJwt(payload) {
    return await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$sign$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SignJWT"]({
        ...payload,
        userId: payload.userId.toString()
    }).setProtectedHeader({
        alg: "HS256",
        typ: "JWT"
    }).setExpirationTime("7d").sign(encoder.encode(JWT_SECRET));
}
async function verifyJwt(token) {
    try {
        const { payload } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$verify$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["jwtVerify"])(token, encoder.encode(JWT_SECRET));
        return payload;
    } catch  {
        return null;
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwtToken$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/jwtToken.ts [middleware-edge] (ecmascript)");
;
;
async function middleware(request) {
    const { pathname } = request.nextUrl;
    const token = request.cookies.get("token")?.value;
    const payload = token ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwtToken$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["verifyJwt"])(token) : null;
    ...
    if (pathname === "/login") {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].next(); // fallback: let them see /login
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dbb05913._.js.map